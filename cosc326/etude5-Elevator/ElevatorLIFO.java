...
public class ElevatorLIFO{
    ...
    public static void lifo(){
        ...
        if (elevator.size() == 0 && personQueue.size() == 0){
            ...
            Person p = personQueue.get(personQueue.size() - 1);
            int desiredFloor = p.getStartFloor();
            if (elevatorCurrentFloor == desiredFloor){
                elevatorDirection = 1;
            } else if (elevatorCurrentFloor < desiredFloor){
                elevatorDirection = 2;
            } else if (elevatorCurrentFloor > desiredFloor){
                elevatorDirection = 0;
            }
